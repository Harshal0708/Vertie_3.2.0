...
class Analyze3Activity : BaseActivity() {

    @Inject
    lateinit var injectedFragment: Analyze3Fragment
    ...
    companion object {
        fun newIntent(context: Context): Intent {
            return Intent(context, Analyze3Activity::class.java)
        }
    }
}